      ...
      <nav className="glass-panel" style={{color: 'var(--text-primary)', padding: '0 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: 75, position: 'sticky', top: 0, zIndex: 100, borderBottom: '1px solid var(--border-muted)', borderRadius: '0 0 24px 24px', margin: '0 10px'}}>
        <div style={{display: 'flex', alignItems: 'center', gap: '50px', height: '100%'}}>
          ...
          <div style={{display: 'flex', gap: '30px', fontSize: 14, fontWeight: 700, height: '100%', alignItems: 'center'}}>
             ...
             <Link href="/my-courses" style={{color: 'var(--text-secondary)', textDecoration: 'none'}}>Khóa học của tôi</Link>
          </div>
        </div>
               ...
               <form onSubmit={handleSave}>
                 <div style={{display: 'flex', gap: 50, marginBottom: 50}}>
                    ...
                    <div style={{width: 150, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20}}>
                       <div style={{width: 130, height: 130, borderRadius: '50%', background: 'rgba(255, 255, 255, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', border: '4px solid var(--glass-border)', boxShadow: '0 10px 30px rgba(0,0,0,0.15)'}}>
                       ...
                       <label style={{fontSize: 13, background: 'var(--primary)', color: '#fff', padding: '12px 24px', borderRadius: 30, cursor: 'pointer', fontWeight: 900, boxShadow: '0 4px 15px var(--primary-light)', transition: '0.3s', textAlign: 'center'}}>
                         📸 Đổi ảnh đại diện
