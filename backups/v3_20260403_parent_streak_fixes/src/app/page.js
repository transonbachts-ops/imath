...
export default async function Home() {
  ...
  let topStudents = [];
    ...
    const [leaderboard] = await pool.query(
       'SELECT id, full_name, email, current_streak, longest_streak FROM users WHERE current_streak > 0 OR longest_streak > 0 ORDER BY current_streak DESC, longest_streak DESC LIMIT 3'
    );
