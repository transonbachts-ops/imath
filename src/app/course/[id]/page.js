           ...
           <div style={{display: 'flex', gap: 15, marginBottom: 40, borderBottom: '1px solid #eee', paddingBottom: 40, flexWrap: 'wrap'}}>
              ...
              {enrollmentStatus === 'approved' && (
                 <Link 
                   ...
                   style={{background: '#0a6ebd', color: '#fff', padding: '12px 25px', fontSize: 15, fontWeight: 'bold', textDecoration: 'none', borderRadius: 4, display: 'flex', alignItems: 'center', gap: 8}}
                 >
                   ▶️ Vào phòng học
                 </Link>
              )}
              ...
              {course.textbook_url && enrollmentStatus === 'approved' && (
                 <a 
                   ...
                   target="_blank"
                   rel="noreferrer"
                   style={{background: '#cc0000', color: '#fff', padding: '12px 25px', fontSize: 15, fontWeight: 'bold', textDecoration: 'none', borderRadius: 4, display: 'flex', alignItems: 'center', gap: 8}}
                 >
                   📖 Đọc SGK Online
                 </a>
              )}
              ...
              {(user?.role === 'admin' || user?.role === 'teacher') && (course.lesson_plan_link || course.lesson_plan_url) && (
                 <a 
                   ...
                   target="_blank" 
                   rel="noreferrer" 
                   style={{background: '#003380', color: '#fff', padding: '12px 25px', fontSize: 15, fontWeight: 'bold', textDecoration: 'none', borderRadius: 4, display: 'flex', alignItems: 'center', gap: 8}}
                 >
                   📄 Giáo Án (Chỉ GV)
                 </a>
              )}
